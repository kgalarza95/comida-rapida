...
public class ProductoCarritoAdapter extends RecyclerView.Adapter<ProductoCarritoAdapter.ProductViewHolder> {
    private List<Producto> productList;
    private Context context;

    public ProductoCarritoAdapter(List<Producto> productList, Context context) {
    ...
    public void onBindViewHolder(ProductViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // Mostrar el diálogo para Quitar al carrito
                mostrarDialogoQuitarCarrito(pos);
            }
        });
    ...
    private void mostrarDialogoQuitarCarrito(final int position) {
        Producto selectedProduct = productList.get(position);

        AlertDialog.Builder builder = new AlertDialog.Builder(context);
        builder.setTitle("Quitar del carrito");
        builder.setMessage("¿Deseas Quitar " + selectedProduct.getNombre() + " del carrito?");
        builder.setPositiveButton("Quitar", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                Toast.makeText(context, "Producto cancelado", Toast.LENGTH_SHORT).show();
            }
        });
